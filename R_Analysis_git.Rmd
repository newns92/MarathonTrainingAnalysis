...
First, I load in the CSV file created in the [R_Cleaning_Garmin_Strava script file](https://github.com/newns92/MarathonTrainingAnalysis/blob/master/R_Backups/RCleaningScript.R), which contains the combined dataset of runs from my Philadelphia Marathon training plan from both Strava and Garmin Connect. I then inspected the data to make sure I have all the correct data in the correct data types.
