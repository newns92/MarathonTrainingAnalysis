...
//The last thing I think I need to do it is to convert the factor **Month** factor variable into a character variable, //based #off of the **monthNum** variable, and then remove **monthNum**, since it then would no longer be needed. 

I should've done this earlier, but it just came to me now that the current class of **Month** won't work for time-series-type data.

```{r convert month}
newFullData$Month <- month.abb[newFullData$monthNum]
#newFullData$monthNum <- NULL
str(newFullData$Month)
```
