...
The last thing I think I need to do it is to convert the factor "Month" factor variable into a character variable, based off of the monthNum variable. I should've done this earlier, but it just came to me now that the current class of Month won't work for time-series type data.
